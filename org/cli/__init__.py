...
from org.cli._errors import EXIT_USER_ERROR, CliError
from org.cli._output import emit_error

_ISSUES_URL = "https://github.com/agentculture/org/issues"
...
def _build_parser() -> argparse.ArgumentParser:
    from org.cli._commands import cli as _cli_group
    from org.cli._commands import doctor as _doctor_cmd
    ...
    parser = _CliArgumentParser(
        prog="org",
        description="org — the AgentCulture org site, published to AgentCulture.org.",
    )
    parser.add_argument(
        "--version",
        action="version",
