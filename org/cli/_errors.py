...
Every failure inside org raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`org.cli._output`,
...
# Exit-code policy. Documented in ``org learn`` output.
# 0      = success
